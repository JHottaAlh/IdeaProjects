...
サブミット1(submit) : <input type="submit" name="submit1" value="サブミット1"/> <br />
サブミット2(submit) : <input type="submit" name="submit2" value="サブミット2"/> <br />
画像(image) : <input type="image" name="image"  src="images/sample_button.png"/> <br />
</form>
...
趣味 : <c:forEach items="${inputsResult.hobby}" var="hobby"> ${hobby}, </c:forEach><br />
国籍 : ${inputsResult.nationality}<br />
言語 : <c:forEach items="${inputsResult.language}" var="language"> ${language}, </c:forEach><br />
